...
final class GoRouterNavigatorImpl({required final GoRouter _router})
    extends INavigator<RouterDetails> {
  this : super() {
    _router.routerDelegate.addListener(() {
      controller.add(
        RouterDetails(uri: _router.state.uri, path: _router.state.path),
      );
    });
  }
