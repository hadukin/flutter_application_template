...
import 'package:flutter_application_template/router_implementation/go_router_impl/part/dialog_page.dart';
import 'package:flutter_application_template/router_implementation/go_router_impl/part/modal_bottom_sheet_page.dart';

import 'package:go_router/go_router.dart';

final class GoRoutingSetupImpl implements IRoutingSetup {
  const GoRoutingSetupImpl();

  @override
  IRouter create() => GoRouterImpl(router: _goRouter);
}
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        Di.instance.getIt<IRouter>().navigator.pop();
                      },
